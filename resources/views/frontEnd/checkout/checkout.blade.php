                                    ...
                                    <div id="payment">
                                        <ul class="payment_methods methods">
                                            ...
                                            <li class="payment_method_paypal">
                                                ...
                                                <label for="payment_method_paypal">PayPal <img alt="PayPal Acceptance Mark" src="../../../../www.paypalobjects.com/webstatic/mktg/Logo/AM_mc_vs_ms_ae_UK.png"><a title="What is PayPal?" onclick="if (!window.__cfRLUnblockHandlers) return false; javascript:window.open('https://www.paypal.com/gb/webapps/mpp/paypal-popup','WIPaypal','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=1060, height=700'); return false;" class="about_paypal" href="https://www.paypal.com/gb/webapps/mpp/paypal-popup" data-cf-modified-9933401236a28d82f80743d4-="">What is PayPal?</a>
                                                </label>
